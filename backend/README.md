...
## Project Structure
    ...
    ├── testapiautoconnect_108327  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_108327`
...
2. Clone this repo and `cd testapiautoconnect_108327`
